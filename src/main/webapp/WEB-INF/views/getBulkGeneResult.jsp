<%@ page import="edu.mcw.rgd.controller.QueryFormController" %>
...
<form action="https://<%=QueryFormController.getHostName()%>/solr/OntoMate/browse" method="post">
<input type="hidden" name="q" value = '${q}'/> 
 ...
 <input type="hidden" name="f.gene_s.facet.sort" value="index"/>
 <input type="hidden" name="f.gene_s.facet.limit" value="1000"/>
 <input type="hidden" name="facet.limit" value="100000"/> 
